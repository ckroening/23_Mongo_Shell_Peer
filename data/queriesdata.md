Results found from querying bios collection:
...
4. a. Find docs that have contribs for OOP or UNIX
...
b. Add to queries: db.queries.insert({ turingaward: [{},{},{}] })
...
b. Add to queries: db.queries.insert({ awardbefore2000: [{},{},{}] })
